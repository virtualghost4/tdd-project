...
class ActividadesConveniosController extends Controller
{
    ...
    {
       $actividad = ActividadConvenio::find($id_actividad);
       return view('actividadesconvenios.edit')->with('actividad',$actividad);
    }
    ...
    {
        $actividad = ActividadConvenio::find($id_actividad)->delete();
        return redirect('actividadesconvenios');
    }
}
